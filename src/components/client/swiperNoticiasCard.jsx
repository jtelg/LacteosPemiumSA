    ...
    <>
      ...
      >
        {[1, 2, 3, 4, 5].map((e, i) => (
          <SwiperSlide
            key={i}
            className="md:py-[4rem] py-[2rem] md:w-auto md:px-0 px-10"
          >
            <div className="flex md:flex-row flex-col bg-[#FAFAFA] rounded-[30px] shadow-[0_2px_5px_rgba(0,0,0,0.1)] hover:shadow-[0_2px_5px_rgba(0,0,0,30%)]">
              ...
              <div className="p-4">
                ...
                <button className="mt-2 md:py-0 py-1 w-full text-primary-500 text-sm bg-white hover:bg-[#ece4e4] brother-500  border-2 border-primary-500  rounded-[30px] ">
