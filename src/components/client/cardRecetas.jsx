...
const Recetas = () => {
  return (
    <div className="bg-[#FAFAFA]  text-start rounded-[30px] shadow-[0_2px_5px_rgba(0,0,0,0.1)] hover:shadow-[0_2px_5px_rgba(0,0,0,30%)] ">
      <img src="/media/recetas.png" alt="quesos" />
